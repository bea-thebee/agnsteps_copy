"""
Detailed Analysis of 4FGL J0725.8-0054: AGN Steps and Light Curve Variability
...
class AGNStepAnalyzer:
    ...
    def __init__(self, source_name: str = '4FGL J0725.8-0054', 
                 info_file: str = 'files/source_info_v1.pkl'):
        """
        Initialize analyzer for a specific source.
        
        Args:
            source_name: Name of source to analyze (4FGL designation)
    ...
    def load_source_data(self) -> bool:
        ...
        try:
            ...
            if self.source_name not in vdb:
                print(f"Error: {self.source_name} not found in database")
                print(f"Available sources: {list(vdb.keys())[:10]}...")
                return False
            
            source_dict = vdb[self.source_name]
            ...
            print(f"✓ Loaded {self.source_name}")
...
"""
  ...
  long-term stability. The middle block ({ratios['bump_width_weeks']:.1f} weeks) represents
...
if __name__ == "__main__":
    ...
    # Create analyzer for 4FGL J0725.8-0054
    analyzer = AGNStepAnalyzer(
        source_name='4FGL J0725.8-0054',
    ...
    if analyzer.load_source_data():
        ...
        plt.savefig('4FGL_J0725_8-0054_light_curve.png', dpi=150, bbox_inches='tight')
        print("✓ Saved light curve plot")
        
        # Ratio analysis plot
        fig2 = analyzer.plot_ratio_analysis()
        plt.savefig('4FGL_J0725_8-0054_ratios.png', dpi=150, bbox_inches='tight')
        print("✓ Saved ratio analysis plot")
